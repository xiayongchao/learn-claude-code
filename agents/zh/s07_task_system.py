...
SYSTEM = f"你是运行在 {WORKDIR} 工作目录下的编码智能体，请使用任务工具规划并跟进各项工作。"
...
class TaskManager:
    ...
    def list_all(self) -> str:
        ...
        lines = []
        for t in tasks:
            marker = {"待处理": "[ ]", "处理中": "[>]", "已完成": "[x]"}.get(t["status"], "[?]")
...
TOOLS = [
    ...
    {"type": "function",
     "function": {"name": "task_create", "description": "创建一个新的任务",
                  "parameters": {"type": "object", "properties": {"subject": {"type": "string"}, "description": {"type": "string"}}, "required": ["subject"]}}},
    {"type": "function",
     "function": {"name": "task_update", "description": "更新任务的状态或依赖关系",
    ...
    {"type": "function",
     "function": {"name": "task_list", "description": "列出所有任务的状态摘要",
                  "parameters": {"type": "object", "properties": {}}}},
    {"type": "function",
     "function": {"name": "task_get", "description": "根据任务 ID获取任务的详细信息",
